...
if __name__ == '__main__':
    ...
    for mode in (3, 2, 1):
        for bitrate in range(800, 2500, 200):
            ...
            av1an = Av1an()
            av1an.encoder = 'aom'
            av1an.encoding_params = f' --threads=8 --cpu-used={mode}  --end-usage=cbr --target-bitrate={bitrate} '
            av1an.output_file = f'aom'
            ...
            # Vmaf_part
            cmd = f'ffmpeg -hide_banner -loglevel error -r 24 -an -i film.mkv  -i aom.mkv -filter_complex [1:v][0:v]libvmaf=model_path=vmaf_v0.6.1.pkl:log_path={bitrate}.log -f null -'
