...
if __name__ == '__main__':
    ...
    for mode in (2, 1):
        for bitrate in range(600, 2100, 200):
                ...
                av1an.encode_pass = 1
                av1an.encoding_params = f' -w 1280 -h 720 -fps-num 24000 -fps-denom 1001 -enc-mode {mode} -rc 1 -tbr {bitrate}'
                ...
                # Vmaf_part
                cmd = f'ffmpeg -r 24 -hide_banner -loglevel error -an -i film.mp4 -i film_av1.mkv -filter_complex ' \
